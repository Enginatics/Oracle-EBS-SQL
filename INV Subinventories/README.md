...
## Description: 
Profile subinventory report with subinvnetory name, description, status, default cost group, type, restriction attributes, and general ledger account linkages. For BR100.
## Categories: 
