# [AP Invoices and Lines](https://www.enginatics.com/reports/ap-invoices-and-lines/)
...
## Parameters
Ledger, Operating Unit, Aging Bucket Name, Display Level, Supplier, Supplier Site, Invoice Number, Inv. Date Period, Inv. Date From, Inv. Date To, Accounting Period, Accounting Date From, Accounting Date To, Payment Period, Payment Date From, Payment Date To, Open only, Days Overdue, Invoice Type, Invoice Status, Payment Status, Expense Account From, Expense Account To, Exclude Cancelled, Invoice on Hold, Hold Name, Has Attachment, Creation Date From, Creation Date To, Show DFF Attributes

## Used tables
[fnd_attached_documents](https://www.enginatics.com/library/?pg=1&find=fnd_attached_documents), [ap_invoice_payments_all](https://www.enginatics.com/library/?pg=1&find=ap_invoice_payments_all), [ap_checks_all](https://www.enginatics.com/library/?pg=1&find=ap_checks_all), [po_headers_all](https://www.enginatics.com/library/?pg=1&find=po_headers_all), [po_distributions_all](https://www.enginatics.com/library/?pg=1&find=po_distributions_all)
...
# Example Report 
[AP Invoices and Lines 29-Jul-2020 201730.xlsx](https://www.enginatics.com/example/ap-invoices-and-lines/)
