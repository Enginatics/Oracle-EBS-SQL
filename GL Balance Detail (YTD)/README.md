# [GL Balance Detail (YTD)](https://www.enginatics.com/reports/gl-balance-detail-ytd/)

## Description: 
Summary GL balance report with totals by segment level, with year to date amount totals.
This report is similar to “GL Balance Detail (pivot)” report, but without showing period amounts.


## Parameters
Ledger, Period, Show Company, Show Account, Show Cost Center, Show Intercompany, Show All Segments, Summary Template, Account Type, GL_SEGMENT1, GL_SEGMENT1 From, GL_SEGMENT1 To, GL_SEGMENT2, GL_SEGMENT2 From, GL_SEGMENT2 To, GL_SEGMENT3, GL_SEGMENT3 From, GL_SEGMENT3 To, GL_SEGMENT4, GL_SEGMENT4 From, GL_SEGMENT4 To, GL_SEGMENT5, GL_SEGMENT5 From, GL_SEGMENT5 To, GL_SEGMENT6, GL_SEGMENT6 From, GL_SEGMENT6 To, GL_SEGMENT7, GL_SEGMENT7 From, GL_SEGMENT7 To, GL_SEGMENT8, GL_SEGMENT8 From, GL_SEGMENT8 To, GL_SEGMENT9, GL_SEGMENT9 From, GL_SEGMENT9 To, GL_SEGMENT10, GL_SEGMENT10 From, GL_SEGMENT10 To, Balance Type, Revaluation Currency, Revaluation Conversion Type

## Used tables
[gl_ledgers](https://www.enginatics.com/library/?pg=1&find=gl_ledgers), [gl_period_statuses](https://www.enginatics.com/library/?pg=1&find=gl_period_statuses), [gl_balances](https://www.enginatics.com/library/?pg=1&find=gl_balances), [gl_code_combinations](https://www.enginatics.com/library/?pg=1&find=gl_code_combinations)
...
# Example Report 
[None](https://www.enginatics.com/example/gl-balance-detail-ytd/)
