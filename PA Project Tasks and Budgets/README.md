# [PA Project Tasks and Budgets](https://www.enginatics.com/reports/pa-project-tasks-and-budgets/)
## Description: 
Summary project report showing operating unit, project number, project name, description, type, status, start date, completion date, closed date, task information, budget information.
## Categories: 
...
[PA_Project_Tasks_and_Budgets.xml](https://www.enginatics.com/xml/pa-project-tasks-and-budgets/)
