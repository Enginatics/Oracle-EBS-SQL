...
/*                                                                       */
/*************************************************************************/
-- Report Name: GL Account Analysis (Distributions) 11g
-- Description: Database 11g version of GL account analysis distribution transaction report with one line per distribution including all segments and subledger data, with amounts in both transaction currency and ledger currency.
-- Excel Examle Output: https://www.enginatics.com/example/gl-account-analysis-distributions-11g/
-- Library Link: https://www.enginatics.com/reports/gl-account-analysis-distributions-11g/
...
case when xte.application_id=222 and xte.entity_code in ('TRANSACTIONS','BILLS_RECEIVABLE') then xte.source_id_int_1 end=rcta.customer_trx_id(+) and
