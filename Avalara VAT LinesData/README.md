# [Avalara VAT LinesData](https://www.enginatics.com/reports/avalara-vat-linesdata/)

## Description: 
Transaction lines export for Avalara tax compliance software
<a href="https://www.avalara.com/" rel="nofollow" target="_blank">https://www.avalara.com/</a>

## Parameters
Invoice Number, Transaction Number, Customer Name like, Account Number, Category, Class, Period, Inv. Date From, Inv. Date To, Status, Overdue for more than x Days, Transaction Type, Transaction Class, Print Date from, Print Date to, Operating Unit

## Used tables
[ra_customer_trx_all](https://www.enginatics.com/library/?pg=1&find=ra_customer_trx_all), [ar_cons_inv_trx_all](https://www.enginatics.com/library/?pg=1&find=ar_cons_inv_trx_all), [ar_cons_inv_all](https://www.enginatics.com/library/?pg=1&find=ar_cons_inv_all), [ra_customer_trx_lines_all](https://www.enginatics.com/library/?pg=1&find=ra_customer_trx_lines_all), [mtl_system_items_b_kfv](https://www.enginatics.com/library/?pg=1&find=mtl_system_items_b_kfv), [ra_cust_trx_line_gl_dist_all](https://www.enginatics.com/library/?pg=1&find=ra_cust_trx_line_gl_dist_all), [okc_k_lines_b](https://www.enginatics.com/library/?pg=1&find=okc_k_lines_b), [okc_k_items](https://www.enginatics.com/library/?pg=1&find=okc_k_items)
...
# Example Report 
[None](https://www.enginatics.com/example/avalara-vat-linesdata/)

# Report SQL
[www.enginatics.com/reports/avalara-vat-linesdata/](https://www.enginatics.com/reports/avalara-vat-linesdata/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[Avalara_VAT_LinesData.xml](https://www.enginatics.com/xml/avalara-vat-linesdata/)
