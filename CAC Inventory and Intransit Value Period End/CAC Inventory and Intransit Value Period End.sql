...
-- =======================================================================
	...
	nvl(cpcs.rollback_quantity,0)),5) Item_Cost,
...
select	nvl(gl.short_name, gl.name) Ledger,
	...
	round(sum(nvl(cpcs.rollback_intransit_value,0)),2) Onhand_Value                                                               -- p_pii_cost_type
from	cst_period_close_summary cpcs,
	org_acct_periods oap,
	mtl_parameters mp,
	-- Revision for version 1.16
...
group by
	...
	-- Added for valuing based on the item costs
	cic.item_cost
-- Order by Ledger, Operating_Unit, Org_Code, Accounts, Item_Number, Subinventory
order by 1,2,3,5,6,7,8,9,10,11,12,15