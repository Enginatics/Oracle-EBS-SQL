...
## Parameters
Report Option, Period Name, Cost Type, PII Cost Type, PII Sub-Element, Include Scrap Quantities, Include Unreleased Jobs, Include Bulk Supply Items, Use Completion Quantities, Category Set 1, Category Set 2, Organization Code, Class Code, Job Status, WIP Job, Component Number, Assembly Number, Operating Unit, Ledger
...
# Example Report 
[CAC ICP PII WIP Material Usage Variance 23-Jun-2022 155150.xlsx](https://www.enginatics.com/example/cac-icp-pii-wip-material-usage-variance/)

# Report SQL
[www.enginatics.com/reports/cac-icp-pii-wip-material-usage-variance/](https://www.enginatics.com/reports/cac-icp-pii-wip-material-usage-variance/)
