...
(select /*+ inline */
 ...
 (select xxen_util.meaning(hrr.responsibility_type,'SITE_USE_CODE',222) from hz_role_responsibility hrr where hrr.cust_account_role_id=hcar.cust_account_role_id and hrr.primary_flag='Y' and rownum=1) contact_primary_role,
 (select x.responsibility_type from (select xxen_util.meaning(hrr.responsibility_type,'SITE_USE_CODE',222) responsibility_type, row_number() over (order by hrr.responsibility_type) rn from hz_role_responsibility hrr where hrr.cust_account_role_id=hcar.cust_account_role_id and nvl(hrr.primary_flag,'N')<>'Y') x where x.rn=1) contact_other_role_1,
 (select x.responsibility_type from (select xxen_util.meaning(hrr.responsibility_type,'SITE_USE_CODE',222) responsibility_type, row_number() over (order by hrr.responsibility_type) rn from hz_role_responsibility hrr where hrr.cust_account_role_id=hcar.cust_account_role_id and nvl(hrr.primary_flag,'N')<>'Y') x where x.rn=2) contact_other_role_2,
 (select x.responsibility_type from (select xxen_util.meaning(hrr.responsibility_type,'SITE_USE_CODE',222) responsibility_type, row_number() over (order by hrr.responsibility_type) rn from hz_role_responsibility hrr where hrr.cust_account_role_id=hcar.cust_account_role_id and nvl(hrr.primary_flag,'N')<>'Y') x where x.rn=3) contact_other_role_3,
 (select x.responsibility_type from (select xxen_util.meaning(hrr.responsibility_type,'SITE_USE_CODE',222) responsibility_type, row_number() over (order by hrr.responsibility_type) rn from hz_role_responsibility hrr where hrr.cust_account_role_id=hcar.cust_account_role_id and nvl(hrr.primary_flag,'N')<>'Y') x where x.rn=4) contact_other_role_4,
 hoc.contact_number,
...
:p_validate_address validate_address,
...
null state,
null postal_code,
null geography_code_override,
null site_address,
null site_phone_country_code,
null site_phone_area_code,
null site_phone_number,
null site_phone_extension,
null site_phone_type,
null site_email_address,
null site_email_format,
null site_email_purpose,
null site_url,
null site_url_purpose,
null site_dff_context,
null hz_party_site_attribute1,
null hz_party_site_attribute2,
null hz_party_site_attribute3,
null hz_party_site_attribute4,
null hz_party_site_attribute5,
null hz_party_site_attribute6,
null hz_party_site_attribute7,
null hz_party_site_attribute8,
null hz_party_site_attribute9,
null hz_party_site_attribute10,
null hz_party_site_attribute11,
null hz_party_site_attribute12,
null hz_party_site_attribute13,
null hz_party_site_attribute14,
null hz_party_site_attribute15,
null hz_party_site_attribute16,
null hz_party_site_attribute17,
null hz_party_site_attribute18,
null hz_party_site_attribute19,
null hz_party_site_attribute20,
--
-- cust account site
--
null operating_unit,
...
null territory,
null translated_cust_name,
null edi_location,
null acct_site_dff_context,
null hz_cust_acct_site_attribute1,
null hz_cust_acct_site_attribute2,
null hz_cust_acct_site_attribute3,
null hz_cust_acct_site_attribute4,
null hz_cust_acct_site_attribute5,
null hz_cust_acct_site_attribute6,
null hz_cust_acct_site_attribute7,
null hz_cust_acct_site_attribute8,
null hz_cust_acct_site_attribute9,
null hz_cust_acct_site_attribute10,
null hz_cust_acct_site_attribute11,
null hz_cust_acct_site_attribute12,
null hz_cust_acct_site_attribute13,
null hz_cust_acct_site_attribute14,
null hz_cust_acct_site_attribute15,
null hz_cust_acct_site_attribute16,
null hz_cust_acct_site_attribute17,
null hz_cust_acct_site_attribute18,
null hz_cust_acct_site_attribute19,
null hz_cust_acct_site_attribute20,
--
-- cust account site use
--
null site_use_purpose,
null site_use_location,
null bill_to_site_use_location,
null primary_site_use,
null site_use_status,
null receivables_account,
null revenue_account,
null tax_account,
null freight_account,
null clearing_account,
null unbilled_rec_account,
null unearned_rec_account,
null charges_activity,
null site_territory,
null site_payment_terms,
null site_primary_salesperson,
null site_contact,
null site_sic_code,
null site_order_type,
null site_price_list,
null site_item_type_identifier,
null site_request_date_type,
null site_freight_terms,
null site_fob_point,
null site_ship_method,
null site_warehouse,
to_number(null) site_earliest_schedule_limit,
to_number(null) site_latest_schedule_limit,
null site_overship_invoice_base,
to_number(null) site_over_shipment_tolerance,
to_number(null) site_under_shipment_tolerance,
to_number(null) site_over_return_tolerance,
to_number(null) site_under_return_tolerance,
null site_push_group_schedule_date,
null site_lines_in_arrival_sets,
null site_lines_in_ship_sets,
null site_demand_class,
null site_internal_location,
null site_internal_organization,
null site_primary_receipt_method,
null site_allow_tax_applicability,
null site_allow_offset_taxes,
null site_self_assessment,
null site_tax_rounding_level,
null site_tax_rounding_rule,
null site_inclusive_tax,
null site_tax_reporting_country,
null site_tax_reporting_reg_type,
null site_tax_reporting_reg_number,
null site_use_tax_registration_num,
null site_use_tax_classification,
null site_use_tax_geography_type,
null site_use_dff_context,
null hz_cust_site_use_attribute1,
null hz_cust_site_use_attribute2,
null hz_cust_site_use_attribute3,
null hz_cust_site_use_attribute4,
null hz_cust_site_use_attribute5,
null hz_cust_site_use_attribute6,
null hz_cust_site_use_attribute7,
null hz_cust_site_use_attribute8,
null hz_cust_site_use_attribute9,
null hz_cust_site_use_attribute10,
null hz_cust_site_use_attribute11,
null hz_cust_site_use_attribute12,
null hz_cust_site_use_attribute13,
null hz_cust_site_use_attribute14,
null hz_cust_site_use_attribute15,
null hz_cust_site_use_attribute16,
null hz_cust_site_use_attribute17,
null hz_cust_site_use_attribute18,
null hz_cust_site_use_attribute19,
null hz_cust_site_use_attribute20,
null hz_cust_site_use_attribute21,
null hz_cust_site_use_attribute22,
null hz_cust_site_use_attribute23,
null hz_cust_site_use_attribute24,
null hz_cust_site_use_attribute25,
--
-- profile
--
nvl2(hcp.cust_account_profile_id,decode(hcp.cust_account_id,-1,xxen_util.meaning('PARTY','REQUESTED_BY',222),xxen_util.meaning('ACCOUNT','HZ_CONS_BILL_LEVEL',222)),null) profile_assignment_level,
...
(select rtv.name from ra_terms_vl rtv where rtv.term_id = hcp.late_charge_term_id) late_chg_terms,
...
ctct.contact_primary_role,
ctct.contact_other_role_1,
ctct.contact_other_role_2,
ctct.contact_other_role_3,
ctct.contact_other_role_4,
ctct.contact_number,
...
to_number(null) location_id,
hca.cust_account_id,
to_number(null) cust_acct_site_id,
...
to_number(null) chart_of_accounts_id,
...
--
hca.party_id = hcp.party_id (+) and
nvl(hcp.site_use_id (+),0) = 0 and
(hcp.cust_account_profile_id is null or
 hcp.cust_account_id = hca.cust_account_id or
 hcp.cust_account_id = -1
) and
...
decode(:p_update_attachments,'Y',hca.cust_account_id,null) = attchmt.entity_id (+)
--
&lp_site_sub_query_filter
--
union all
--
-- Q2 Site Level
...
case when hcsua.site_use_code = 'SHIP_TO' then (select hl.location_code from po_location_associations_all poaa, hr_locations hl where poaa.site_use_id = hcsua.site_use_id and poaa.org_id = hcsua.org_id and poaa.location_id = hl.location_id and rownum = 1) else null end site_internal_location,
case when hcsua.site_use_code = 'SHIP_TO' then (select ood.organization_name from po_location_associations_all poaa, org_organization_definitions ood where poaa.site_use_id = hcsua.site_use_id and poaa.org_id = hcsua.org_id and poaa.organization_id = ood.organization_id and rownum = 1) else null end site_internal_organization,
(select
 rm.name receipt_method
 from
 ra_cust_receipt_methods rcrm,
