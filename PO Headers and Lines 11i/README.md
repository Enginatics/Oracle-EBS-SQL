# [PO Headers and Lines 11i](https://www.enginatics.com/reports/po-headers-and-lines-11i/)

## Description: 
PO headers, lines, receiving transactions and corresponding AP invoices

## Parameters
Operating Unit, PO Number, Buyer, Supplier, Supplier Site, Item, Item Type, WIP Job, Project, Has Open Quantity, Promised, Overdue, Open only, Exclude Cancelled, PO Creation Date From, PO Creation Date To, PO Created By
...
# Example Report 
[None](https://www.enginatics.com/example/po-headers-and-lines-11i/)

# Report SQL
[www.enginatics.com/reports/po-headers-and-lines-11i/](https://www.enginatics.com/reports/po-headers-and-lines-11i/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[PO_Headers_and_Lines_11i.xml](https://www.enginatics.com/xml/po-headers-and-lines-11i/)
