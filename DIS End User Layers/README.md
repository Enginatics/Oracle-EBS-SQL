# [DIS End User Layers](https://www.enginatics.com/reports/dis-end-user-layers/)
...
## Related reports
[DIS Workbook Import Validation](/DIS%20Workbook%20Import%20Validation/), [DIS Migration identify missing EulConditions](/DIS%20Migration%20identify%20missing%20EulConditions/)

## Dependencies
If you would like to try one of these Oracle EBS SQLs without having Blitz Report installed, note that some of the reports require functions from utility package [xxen_util](https://www.enginatics.com/xxen_util/true).

# Example Report 
[None](https://www.enginatics.com/example/dis-end-user-layers/)

# Report SQL
[www.enginatics.com/reports/dis-end-user-layers/](https://www.enginatics.com/reports/dis-end-user-layers/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[DIS_End_User_Layers.xml](https://www.enginatics.com/xml/dis-end-user-layers/)
