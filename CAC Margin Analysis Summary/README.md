...
## Description: 
Summary report for the margin from the customer invoices and shipments, based on the standard Oracle Margin table, cst_margin_summary. Does not show the COGS and Sales Accounts. You first need to run the Margin Analysis Build request, to populate this table.
## Categories: 
