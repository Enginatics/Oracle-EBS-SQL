...
zrv.tax_regime_code,
zrv.tax_regime_name,
xxen_util.yes(zrv.allow_recoverability_flag) allow_tax_recovery,
xxen_util.yes(zrv.tax_inclusive_override_flag) allow_tax_inclusive_override,
xxen_util.yes(zrv.allow_exemptions_flag) allow_tax_exemptions,
xxen_util.yes(zrv.allow_exceptions_flag) allow_tax_exceptions,
...
xxen_util.yes(zrv.has_other_jurisdictions_flag) allow_multiple_jurisdictions,
xxen_util.yes(zrv.allow_rounding_override_flag) allow_tax_rounding_override,
...
xxen_util.yes(zrv.regn_num_same_as_le_flag) use_legal_registration_number,
xxen_util.yes(zrv.cross_regime_compounding_flag) allow_cross_regime_compounding,
