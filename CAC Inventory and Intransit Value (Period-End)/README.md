...
## Parameters
Period Name (Closed), Cost Type, Category Set 1, Category Set 2, Item Number, Subinventory, Organization Code, Operating Unit, Ledger
...
# Example Report 
[CAC Inventory and Intransit Value (Period-End) - Pivot by Org 22-Oct-2022 191023.xlsx](https://www.enginatics.com/example/cac-inventory-and-intransit-value-period-end/)
