# [CAC Inactive Items Set to Roll Up](https://www.enginatics.com/reports/cac-inactive-items-set-to-roll-up/)
...
## Parameters
Cost Type, Inactive Item Status, Category Set 1, Category Set 2, Item Number, Organization Code, Operating Unit, Ledger
...
# Example Report 
[None](https://www.enginatics.com/example/cac-inactive-items-set-to-roll-up/)

# Report SQL
[www.enginatics.com/reports/cac-inactive-items-set-to-roll-up/](https://www.enginatics.com/reports/cac-inactive-items-set-to-roll-up/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[CAC_Inactive_Items_Set_to_Roll_Up.xml](https://www.enginatics.com/xml/cac-inactive-items-set-to-roll-up/)
