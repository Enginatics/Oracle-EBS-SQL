...
from
   (select
    ...
    ,'P:' || hp2.pn period_num
    ,decode(substr(:summary_level,1,1),'P',null,'W:' || hp2.wn) week_num
    ,decode(substr(:summary_level,1,1),'D','D:' || hp2.dn,null) day_num
    ,decode(substr(:summary_level,1,1),'P',hp2.pe_date,'W',hp2.we_date,hp2.bucket_date) bucket_date
