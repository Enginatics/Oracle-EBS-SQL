...
/*                                                                       */
/*************************************************************************/
-- Report Name: INV Inventory Item Upload
...
-- Excel Examle Output: https://www.enginatics.com/example/inv-inventory-item-upload/
-- Library Link: https://www.enginatics.com/reports/inv-inventory-item-upload/
...
(select muomt.unit_of_measure_tl from mtl_units_of_measure_tl muomt where muomt.uom_code = msiv.service_duration_period_code and rownum <= 1) contract_duration_period,
