...
xxen_util.yes(mpv.enforce_locator_alis_unq_flag) enforce_locator_alias_unique,
xxen_util.yes(mpv.qa_skipping_insp_flag) quality_skip_inspect_control,
xxen_util.meaning(decode(mpv.negative_inv_receipt_code,1,1),'SYS_YES_NO',700) allow_negative_balances,
xxen_util.yes(mpv.auto_del_alloc_flag) auto_delete_allocations,
xxen_util.yes(mpv.trading_partner_org_flag) manufacturing_partner_org,
mpv.trading_partner_org_type manufacturing_partner_org_type,
xxen_util.yes(mpv.eam_enabled_flag) eam_enabled,
xxen_util.yes(mpv.wms_enabled_flag) wms_enabled,
xxen_util.yes(mpv.wcs_enabled) wcs_enabled,
xxen_util.yes(mpv.lcm_enabled_flag) lcm_enabled,
xxen_util.meaning(decode(mpv.enable_ekanban,1,1),'SYS_YES_NO',700) ekanban_enabled,
xxen_util.yes(mpv.process_enabled_flag) process_manufacturing_enabled,
...
xxen_util.yes(mpv.child_lot_zero_padding_flag) child_lot_zero_padding,
mpv.child_lot_alpha_prefix child_lot_prefix,
mpv.child_lot_number_length child_lot_length,
xxen_util.yes(mpv.child_lot_validation_flag) child_lot_format_validation,
xxen_util.yes(mpv.copy_lot_attribute_flag) copy_child_lot_attributes,
decode(mpv.create_lot_uom_conversion,1,'Yes',2,'No',3,'User confirmation') auto_create_lot_uom_conversion,
decode(mpv.allow_different_status,1,'Yes',2,'No',3,'With exception') allow_different_material_status,
decode(mpv.serial_number_type,1,'Within inventory model and items',2,'Within organization',3,'Across organizations',4,'Within inventory items') serial_control_uniqueness,
xxen_util.meaning(mpv.serial_number_generation,'MTL_LOT_GENERATION',700) serial_control_generation,
mpv.auto_serial_alpha_prefix prefix,
mpv.start_auto_serial_number starting_serial_number,
decode(mpv.allocate_serial_flag,'Y','Yes','N','No','C','Yes - User Defined') allocate_serial_numbers,
mpv.total_lpn_length,
mpv.lpn_starting_number starting_lpn_number,
mpv.lpn_prefix,
mpv.lpn_suffix,
xxen_util.yes(mpv.ucc_128_suffix_flag) ucc_128_suffix,
