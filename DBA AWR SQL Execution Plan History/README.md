...
## Parameters
SQL Id, Plan Hash Value, Using Index, Object Name, Options, Objects larger than x GB, Diagnostic Pack enabled, Container Data
...
## Related reports
[DBA AWR SQL Performance Summary](/DBA%20AWR%20SQL%20Performance%20Summary/), [DBA SGA SQL Execution Plan History](/DBA%20SGA%20SQL%20Execution%20Plan%20History/)

## Dependencies
If you would like to try one of these Oracle EBS SQLs without having Blitz Report installed, note that some of the reports require functions from utility package [xxen_util](https://www.enginatics.com/xxen_util/true).

# Example Report 
[None](https://www.enginatics.com/example/dba-awr-sql-execution-plan-history/)
