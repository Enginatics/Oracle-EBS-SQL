# [INV Organization Access](https://www.enginatics.com/reports/inv-organization-access/)
## Description: 
Master data report for Inventory orgs, with org code, application, responsibility and creation information. Allows BR100 creation.
## Categories: 
