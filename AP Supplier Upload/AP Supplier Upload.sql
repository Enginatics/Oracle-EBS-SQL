...
xxen_util.meaning(zptp0.rounding_rule_code,'ZX_ROUNDING_RULE',0) tax_rounding_rule,
xxen_util.meaning(zptp0.inclusive_tax_flag,'YES_NO',0) inclusive_tax,
xxen_util.meaning(zptp0.process_for_applicability_flag,'YES_NO',0) allow_tax_applicability,
xxen_util.meaning(zptp0.self_assess_flag,'YES_NO',0) self_assessment,
xxen_util.meaning(zptp0.allow_offset_tax_flag,'YES_NO',0) allow_offset_taxes,
...
xxen_util.meaning(iepa0.exclusive_payment_flag,'YES_NO',0) pay_each_document_alone,
...
xxen_util.meaning(zptp1.rounding_rule_code,'ZX_ROUNDING_RULE',0) site_tax_rounding_rule,
xxen_util.meaning(zptp1.inclusive_tax_flag,'YES_NO',0) site_inclusive_tax,
xxen_util.meaning(zptp1.process_for_applicability_flag,'YES_NO',0) site_calculate_tax,
...
xxen_util.meaning(iepa1.exclusive_payment_flag,'YES_NO',0) site_pay_each_document_alone,
