...
## Description: 
Report showing amount of inventory at the end of the month.  If you enter a cost type this report uses the item costs from the month-end snapshot; if you leave the cost type blank it uses the month-end snapshot.  In either case this report uses the month-end quantities, based on the entered period name.
...
[rep_CAC_Inventory_and_Intransit_Value_Period_End.xml](https://www.enginatics.com/xml/cac-inventory-and-intransit-value-period-end/)
