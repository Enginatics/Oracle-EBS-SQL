# [DBA Segments](https://www.enginatics.com/reports/dba-segments/)

## Description: 
Database segments such as tables, indexes, lob segments by size and total database size summary

## Parameters
Group by, Segment Name like, Segment Type, Table Name, Tablespace Name, Owner, Size bigger than x MB
...
# Example Report 
[None](https://www.enginatics.com/example/dba-segments/)

# Report SQL
[www.enginatics.com/reports/dba-segments/](https://www.enginatics.com/reports/dba-segments/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[DBA_Segments.xml](https://www.enginatics.com/xml/dba-segments/)
