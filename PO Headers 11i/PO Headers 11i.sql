...
-- Excel Examle Output: https://www.enginatics.com/example/po-headers-11i/
-- Library Link: https://www.enginatics.com/reports/po-headers-11i/
...
(select distinct aida.invoice_id, pda.po_header_id, pda.po_release_id from ap_invoice_distributions_all aida, po_distributions_all pda where aida.po_distribution_id=pda.po_distribution_id) aila,
ap_invoices_all aia
where
1=1 and
