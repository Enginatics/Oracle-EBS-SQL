...
## Description: 
Profile Report to show the accounting period status for General Ledger, Inventory, Lease Management, Payables, Projects, Purchasing and Receivables. You can choose 'All Statuses' (open or closed or never opened). This report will also display the process manufacturing cost calendar status.
## Categories: 
