...
-- Excel Examle Output: https://www.enginatics.com/example/cac-manufacturing-variance-summary/
-- Library Link: https://www.enginatics.com/reports/cac-manufacturing-variance-summary/
...
-- Detail Report Only	&segment_columns
...
-- Detail Report Only	wip_sum.operation_seq_num Operation_Seq_Number,
-- Detail Report Only	wip_sum.item_or_res_op_seq Item_or_Res_Operation_Seq,
-- Detail Report Only	bd.department_code Department,
-- Detail Report Only	wip_sum.item_or_resource Component_or_Resource,
-- Detail Report Only	wip_sum.item_or_res_description Description,
	-- Revision for version 1.24
-- Detail Report Only	wip_sum.resource_uom_code Resource_UOM,
-- Detail Report Only	wip_sum.overhead Overhead,
-- Detail Re