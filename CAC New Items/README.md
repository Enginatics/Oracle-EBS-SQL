# [CAC New Items](https://www.enginatics.com/reports/cac-new-items/)
...
## Parameters
Creation Date From, Creation Date To, Include Uncosted Items, Assignment Set, Category Set 1, Category Set 2, Organization Code, Operating Unit, Ledger
...
## Related reports
[CAC Inventory Organization Summary](/CAC%20Inventory%20Organization%20Summary/)

## Dependencies
If you would like to try one of these Oracle EBS SQLs without having Blitz Report installed, note that some of the reports require functions from utility package [xxen_util](https://www.enginatics.com/xxen_util/true).

# Example Report 
[CAC New Items 07-Jul-2022 142245.xlsx](https://www.enginatics.com/example/cac-new-items/)

# Report SQL
[www.enginatics.com/reports/cac-new-items/](https://www.enginatics.com/reports/cac-new-items/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[CAC_New_Items.xml](https://www.enginatics.com/xml/cac-new-items/)
