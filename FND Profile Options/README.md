# [FND Profile Options](https://www.enginatics.com/reports/fnd-profile-options/)

## Description: 
FND profile option definition

## Parameters
User Profile Name starts with, System Profile Name starts with, Show active only
...
## Related reports
[CAC Inventory Accounts Setup](/CAC%20Inventory%20Accounts%20Setup/)

## Dependencies
If you would like to try one of these Oracle EBS SQLs without having Blitz Report installed, note that some of the reports require functions from utility package [xxen_util](https://www.enginatics.com/xxen_util/true).

# Example Report 
[FND Profile Options 03-Apr-2018 105618.xlsx](https://www.enginatics.com/example/fnd-profile-options/)
