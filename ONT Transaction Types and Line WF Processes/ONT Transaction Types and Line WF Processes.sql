...
-- Description: Master data report showing the setup of order management transaction types and associated line types and workflow processes.Suitable for BR100 creation.
...
(select owa.* from oe_workflow_assignments owa where '&enable_line'='Y' and owa.line_type_id is not null and nvl(owa.wf_item_type,'OEOL')='OEOL') owa3,
