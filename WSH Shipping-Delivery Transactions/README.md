# [WSH Shipping/Delivery Transactions](https://www.enginatics.com/reports/wsh-shipping-delivery-transactions/)
...
## Parameters
Selling Operating Unit, Shipping Operating Unit, Organization Code, Assigned to Delivery, Delivery Status, Exclude Delivery Status, Release status, Exclude Release Status, Exception Exists, Customer Name, Customer Number, Delivery Note From, Delivery Note To, Item From, Item To, Order Number From, Order Number To, Scheduled Date From, Scheduled Date To, Released Date From, Released Date To, Actual Shipment Date From, Actual Shipment Date To, Invoiced Date From, Invoiced Date To, Initial Pick Up Date From, Initial Pick Up Date To, Ultimate Drop Off Date From, Ultimate Drop Off Date To, Location Format
...
# Example Report 
[None](https://www.enginatics.com/example/wsh-shipping-delivery-transactions/)

# Report SQL
[www.enginatics.com/reports/wsh-shipping-delivery-transactions/](https://www.enginatics.com/reports/wsh-shipping-delivery-transactions/)

# [Blitz Report™](https://www.enginatics.com/blitz-report/) import options
[WSH_Shipping_Delivery_Transactions.xml](https://www.enginatics.com/xml/wsh-shipping-delivery-transactions/)
