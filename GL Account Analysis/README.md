---
layout: default
title: 'GL Account Analysis | Oracle EBS SQL Report'
description: 'Detail GL transaction report with one line per transaction including all segments and subledger data, with amounts in both transaction currency and ledger…'
keywords: 'Oracle EBS, Oracle E-Business Suite, SQL report, Blitz Report, Enginatics, R12 only, Account, Analysis, fnd_flex_value_norm_hierarchy, gl_code_combinations_kfv, xla_event_types_tl'
permalink: /GL%20Account%20Analysis/
---

# GL Account Analysis – Oracle EBS SQL Report

**Oracle E-Business Suite** SQL report from the [Enginatics Library](https://www.enginatics.com/reports/gl-account-analysis/) powered by [Blitz Report™](https://www.enginatics.com/blitz-report/).
...
| Resource | Link |
|---|---|
| Excel Example Output | [GL Account Analysis - Pivot by Account Hierarchy 17-Jan-2023 194056.xlsx](https://www.enginatics.com/example/gl-account-analysis/) |
| Blitz Report™ XML Import | [GL_Account_Analysis.xml](https://www.enginatics.com/xml/gl-account-analysis/) |
| Full SQL on Enginatics | [www.enginatics.com/reports/gl-account-analysis/](https://www.enginatics.com/reports/gl-account-analysis/) |
