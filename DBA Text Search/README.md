# [DBA Text Search](https://www.enginatics.com/reports/dba-text-search/)

## Description: 
Full text search through database source code objects such as packages, procedures, functions, triggers etc.

## Parameters
Code Text contains, Object Name starts with, FND Message Text, Object Type, Schema
...
# Example Report 
[DBA Text Search 11-May-2017 125907.xlsx](https://www.enginatics.com/example/dba-text-search/)
