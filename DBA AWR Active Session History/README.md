# [DBA AWR Active Session History](https://www.enginatics.com/reports/dba-awr-active-session-history/) (**https://www.enginatics.com/reports/dba-awr-active-session-history/**)
## Description: 
