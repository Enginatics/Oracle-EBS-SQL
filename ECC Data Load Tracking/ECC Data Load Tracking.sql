...
/*                                                                       */
/*************************************************************************/
-- Report Name: ECC Data Load Tracking
-- Description: Enterprise Command Centers applicatios with data sets and load rule DB procedure names for incremental, full and metadata load.
For description of the load process, see ECC Concurrent Programs https://www.enginatics.com/reports/ecc-concurrent-programs/
-- Excel Examle Output: https://www.enginatics.com/example/ecc-data-load-tracking/
-- Library Link: https://www.enginatics.com/reports/ecc-data-load-tracking/
