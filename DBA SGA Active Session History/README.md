# [DBA SGA Active Session History](https://www.enginatics.com/reports/dba-sga-active-session-history/) (**https://www.enginatics.com/reports/dba-sga-active-session-history/**)
## Description: 
