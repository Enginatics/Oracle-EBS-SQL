...
/*                                                                       */
/*************************************************************************/
-- Report Name: RK: AR Transactions and Lines
...
-- Excel Examle Output: https://www.enginatics.com/example/rk-ar-transactions-and-lines/
-- Library Link: https://www.enginatics.com/reports/rk-ar-transactions-and-lines/
-- Run Report: https://demo.enginatics.com/

select
decode(x.class,'Credit Memo',2,'Invoice',0) "DocumentType",
null "SequencialNumberVK",
null "SequencialNumberAK",
x.trx_date "TransactionDate",
x.invoice_number "InvoiceNumber",
x.trx_number "SupplierInvoiceNumber",
null "LastInvoiceNumber",
null "DocumentIndicator",
null "OwnReference",
x.ref_invoice_num "ReferenceInvoiceNumber",
x.ref_invoice_date "ReferenceInvoiceDate",
null "ReferenceTaxableBasis",
null "ReferenceVAT",
null "AutoFatturaNumber",
x.invoice_date "InvoiceDate",
x.currency "Currency",
null "Currency2",
null "Currency3",
null "DocumentCurrency",
x.exchange_date "ExchangeRateDate",
null "Discount",
null "DateOfSupply",
x.tax_rate "VATCode",
null "VATCodeScheme",
...
x.address1 "CustomerStreet",
x.address2 "CustomerHouseNumber",
x.postal_code "CustomerZip",
x.city "CustomerCity",
x.country "CustomerCountry",
...
abs(nvl(x.tax_amount,0)) "ValueVAT",
null "SalesVATDueReverseCharge",
abs(x.amount)+abs(nvl(x.tax_amount,0)) "TotalValueLine",
...
x.uom_code "Unit",
null "ItemIdentifier",
x.country "CountryDispatch",
x.country "CountryArrival",
null "ShipToCity",
null "ShipToZIP",
null "ShipToStreet",
...
null "Quantity2",
null "Unit2",
abs(x.amount)+abs(nvl(x.tax_amount,0)) "CommercialValue",
...
(select rcta0.trx_number from ra_customer_trx_all rcta0 where rcta.previous_customer_trx_id=rcta0.customer_trx_id) ref_invoice_num,
(select rcta0.trx_date from ra_customer_trx_all rcta0 where rcta.previous_customer_trx_id=rcta0.customer_trx_id) ref_invoice_date,
