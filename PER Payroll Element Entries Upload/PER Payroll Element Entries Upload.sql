...
to_char(null) effective_date,
to_char(peef.effective_start_date,'DD-Mon-YYYY') effective_start_date, 
to_char(peef.effective_end_date,'DD-Mon-YYYY') effective_end_date,
input1_value_name,
input1_value_id,
input1_entry_value,
input2_value_name,
