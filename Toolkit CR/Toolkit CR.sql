...
/*                                                                       */
/*************************************************************************/
-- Report Name: Toolkit - CR
-- Description: Use this to monitor bottlenecks, or failing requests. Typically scheduled to run every 2 hours to detect issues before process impacts. Can be run incrementally, e.g. if running 4 times a day, will only report the delta requests since the last run
-- Excel Examle Output: https://www.enginatics.com/example/toolkit-cr/
-- Library Link: https://www.enginatics.com/reports/toolkit-cr/
